...
\newcommand{\websiteurl}{https://www.google.com} % your site url
\newcommand{\websitename}{google.com}            % short name for printing
...
% materials online, be sure to incorporate them below.
